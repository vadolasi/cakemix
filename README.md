...
This is just a basic tutorial to show what Cakemix is capable of. For something more complete, see the [documentation](https://cakemix.tk/docs/quickstart/overview).
